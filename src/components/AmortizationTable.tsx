        ...
        <tbody>
          {rows.map((row) => (
            ...
            >
              ...
              <td class="px-3 py-2 text-right text-red-700 dark:text-red-400">{fmt(row.interestPart)}</td>
              <td class="px-3 py-2 text-right">{fmt(row.balance)}</td>
              <td class="px-3 py-2 text-right text-red-700 dark:text-red-400">{fmt(row.cumulativeInterest)}</td>
              <td class="px-3 py-2 text-right text-blue-700 dark:text-blue-400">{fmt(row.cumulativePrincipal)}</td>
            </tr>
          ))}
        </tbody>
      </table>
