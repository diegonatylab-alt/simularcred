...
const CONFIGS: CurrencyConfig[] = [
  {
    currency: 'MXN',
    country: 'México',
    amounts: [100000, 300000, 500000, 1000000, 3000000],
    rates: [10, 14, 18],
  ...
  },
  {
    currency: 'COP',
    country: 'Colombia',
    amounts: [10000000, 30000000, 50000000, 100000000],
    rates: [12, 18, 24],
    smallThreshold: 30000000,
  ...
  },
  {
    currency: 'PEN',
    country: 'Perú',
    amounts: [20000, 50000, 100000, 300000],
    rates: [10, 15, 20],
  ...
  },
  {
    currency: 'ARS',
    country: 'Argentina',
    amounts: [5000000, 10000000, 50000000, 100000000],
    rates: [50, 80, 100],
  ...
  },
  {
    ...
    amounts: [10000, 50000, 100000, 300000],
    rates: [6, 8, 10],
    smallThreshold: 50000,
